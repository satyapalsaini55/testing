...
public class View_All_Tabs_In_View_Audit extends
	...
	@Test(priority = 1)
	public void View_All_Tabs_In_View_Audit_Functionality() throws Throwable {

		fnpMymsg(" **************************************************************");
		fnpMymsg(" Executing View_All_Tabs_In_View_Audit_Functionality");

		try {
			

			if (!(fnpCheckElementDisplayedImmediately("SearchAudit_SnapshotTabLink"))) {
			...
			fnpClick_OR("SearchAudit_SnapshotTabLink");
			
			// code here to verify is it snapshot loaded properly.
			...
			fnpClick_OR("SearchAudit_InfoTabLink");			
			Assert.assertTrue(fnpCheckElementPresenceImmediately("visitLinkInInfoTab"), 
					"visit link is not present in Info tab , so might be info tab has not been loaded properly.");
			
		
			
			fnpClick_OR("SearchAudit_CorrectiveActionTabLink");			
			Assert.assertTrue(fnpCheckElementPresenceImmediately("SearchAudit_CorrectiveActionTab_showAllLink"), 
					"Show All link is not present in Corrective Actions tab , so might be Corrective Actions tab has not been loaded properly.");
			...
			fnpClick_OR("SearchAudit_DocumentsTabLink");
			// code here to verify is it Documents tab loaded properly.
			...
			fnpClick_OR("SearchAudit_CorrespondenceTabLink");
			Assert.assertTrue(fnpCheckElementPresenceImmediately("SearchAudit_CorrespondenceTab_EmailCorrespondenceLabel"), 
					"Email Correspondence Label is not present in Correspondence  tab , so might be Correspondence tab has not been loaded properly.");
		
			
			
			
			
			fnpClick_OR("SearchAudit_HistoryTabLink");
			// code here to verify is it History tab loaded properly.
			
			
			
			fnpClick_OR("SearchAudit_FacilityProfileTabLink");
			// code here to verify is it Facility Profile tab loaded properly.
			...
			fnpCommonFinalCatchBlock(t, "  View_All_Tabs_In_View_Audit_Functionality is fail . ", "View_All_Tabs_In_View_Audit_Functionality");

...
public class Escalation_FBY_8Issues_Scenario1 extends TestSuiteBase_IM{
	...
	public static String issue_id_red_eight="I0060497";
	...
	public static String TitleShortDescriptionText="EscFBY_8Issues_S1[BS-12], D/T=";
	...
	@BeforeClass (description="OracleQueryLaunch_ToClosed_OpenIssues_and_InActiveAlerts_Whose --- productCode(501214), Issue_Type(FBY) and Client(NSF-CMiRetailTestingClient")
...
public void Launch_Browser_and_Successfully_Login_into_the_Application() throws Throwable{
	fnApps_Report_Logs("################################## [BS-12]  Create Escalation FBY Eight Issues Scenario");
	...
	public void Escalation_FBY_FirstIssue_Green() throws Throwable{
		
			
		fnApps_Report_Logs("################### Test Case ::::::1 Escalation_FBY_FirstIssue_Green ");
...
//		IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
		...
		fnVerify_SiteDetailsPage_Data_Entered_and_NavigateTo_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 2), IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 2));
	
		//Summary Details page data entered and clicking on next button
		fnVerify_SummaryDetailsPage_Data_Entered_and_NavigateTo_CustomerDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 6), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 7), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 8), IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 3), TitleShortDescriptionText);
		...
		fnVerify_ProductDetailsPage_Data_Entered_and_NavigateTo_DocumentsDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 9));
	...
	@Test(dependsOnMethods={"Escalation_FBY_FirstIssue_Green"}, priority = 2, description="  [Create Issue ID with Amber color]")
	public void Escalation_FBY_SecondIssue_Amber() throws Throwable{
		
		fnApps_Report_Logs("=========================================================================================================================================");
		fnApps_Report_Logs("################### Test Case ::::::2 Escalation_FBY_SecondIssue_Amber ");
	//	IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
		...
		//Site Details page data entered and clicking on next button
		fnVerify_SiteDetailsPage_Data_Entered_and_NavigateTo_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 2),IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 4));
	
		//Summary Details page data entered and clicking on next button
		fnVerify_SummaryDetailsPage_Data_Entered_and_NavigateTo_CustomerDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 6), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 7), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 8), IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 5), TitleShortDescriptionText);
	...
	@Test(dependsOnMethods={"Escalation_FBY_SecondIssue_Amber"}, priority = 3, description="  [Create Issue ID with Amber color]")
	public void Escalation_FBY_ThirdIssue_Amber() throws Throwable{
		
		fnApps_Report_Logs("=========================================================================================================================================");
		fnApps_Report_Logs("################### Test Case ::::::3 Escalation_FBY_ThirdIssue_Amber ");
	//	IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
		...
		//Site Details page data entered and clicking on next button
		fnVerify_SiteDetailsPage_Data_Entered_and_NavigateTo_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 2), IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 6));
	
		//Summary Details page data entered and clicking on next button
		fnVerify_SummaryDetailsPage_Data_Entered_and_NavigateTo_CustomerDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 6), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 7), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 8), IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 7), TitleShortDescriptionText);
	...
	@Test(dependsOnMethods={"Escalation_FBY_ThirdIssue_Amber"}, priority = 4, description="  [Create Issue ID with Amber color]")
	public void Escalation_FBY_FourthIssue_Amber() throws Throwable{
		
		fnApps_Report_Logs("=========================================================================================================================================");
		fnApps_Report_Logs("################### Test Case ::::::4 Escalation_FBY_FourthIssue_Amber ");
	//	IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
		...
		//Site Details page data entered and clicking on next button
		fnVerify_SiteDetailsPage_Data_Entered_and_NavigateTo_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 2),IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 8));
	
		//Summary Details page data entered and clicking on next button
		fnVerify_SummaryDetailsPage_Data_Entered_and_NavigateTo_CustomerDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 6), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 7), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 8), IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 9), TitleShortDescriptionText);
	...
	@Test(dependsOnMethods={"Escalation_FBY_FourthIssue_Amber"}, priority = 5, description="  [Create Issue ID with Amber color]")
	public void Escalation_FBY_FifthIssue_Amber() throws Throwable{
		
		fnApps_Report_Logs("=========================================================================================================================================");
		fnApps_Report_Logs("################### Test Case ::::::5 Escalation_FBY_FifthIssue_Amber ");
//		IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
		...
		//Site Details page data entered and clicking on next button
		fnVerify_SiteDetailsPage_Data_Entered_and_NavigateTo_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 2), IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 10));
	
		//Summary Details page data entered and clicking on next button
		fnVerify_SummaryDetailsPage_Data_Entered_and_NavigateTo_CustomerDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 6), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2,7), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 8), IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 11), TitleShortDescriptionText);
	...
	@Test(dependsOnMethods={"Escalation_FBY_FifthIssue_Amber"}, priority = 6, description="  [Create Issue ID with Amber color]")
	public void Escalation_FBY_SixthIssue_Amber() throws Throwable{
		
		fnApps_Report_Logs("=========================================================================================================================================");
		fnApps_Report_Logs("################### Test Case ::::::6 Escalation_FBY_SixthIssue_Amber ");
	//	IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
		...
		//Site Details page data entered and clicking on next button
		fnVerify_SiteDetailsPage_Data_Entered_and_NavigateTo_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 2), IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 12));
	
		//Summary Details page data entered and clicking on next button
		fnVerify_SummaryDetailsPage_Data_Entered_and_NavigateTo_CustomerDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 6), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 7), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 8), IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 13), TitleShortDescriptionText);
	...
	@Test(dependsOnMethods={"Escalation_FBY_SixthIssue_Amber"}, priority = 7, description="  [Create Issue ID with Amber color]")
	public void Escalation_FBY_SeventhIssue_Amber() throws Throwable{
		
		fnApps_Report_Logs("=========================================================================================================================================");
		fnApps_Report_Logs("################### Test Case ::::::7 Escalation_FBY_SeventhIssue_Amber ");
//		IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
		...
		//Site Details page data entered and clicking on next button
		fnVerify_SiteDetailsPage_Data_Entered_and_NavigateTo_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 2), IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 14));
	
		//Summary Details page data entered and clicking on next button
		fnVerify_SummaryDetailsPage_Data_Entered_and_NavigateTo_CustomerDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 6), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 7), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 8), IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 15), TitleShortDescriptionText);
	...
	@Test(dependsOnMethods={"Escalation_FBY_SeventhIssue_Amber"}, priority = 8, description="  [Create Issue ID with RED color]")
	public void Escalation_FBY_EighthIssue_Red() throws Throwable{
		
		fnApps_Report_Logs("=========================================================================================================================================");
		fnApps_Report_Logs("################### Test Case ::::::8 Escalation_FBY_EighthIssue_Red ");
//		IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
		...
		//Site Details page data entered and clicking on next button
		fnVerify_SiteDetailsPage_Data_Entered_and_NavigateTo_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 2), IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 16));
	
		//Summary Details page data entered and clicking on next button
		fnVerify_SummaryDetailsPage_Data_Entered_and_NavigateTo_CustomerDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 6), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 7), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 8), IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 17), TitleShortDescriptionText);
	...
	@Test(dependsOnMethods={"Escalation_FBY_EighthIssue_Red"}, priority = 9, description="  [Verify Escalations ID Generated with 8 issues.]")
	public void Escalation_FBY_Generated_With_8_Issues() throws Throwable{
		fnApps_Report_Logs("=========================================================================================================================================");
		fnApps_Report_Logs("################### Test Case ::::::9 Escalation_FBY_Generated_With_8_Issues ");
	...
	@Test(dependsOnMethods={"Escalation_FBY_Generated_With_8_Issues"}, priority = 10, description="  [Edit Issue8 SubType and Verify Escalation Dismantled and there are no issue exists into Escalation.]")
	public void Escalation_FBY_Edit_05NOV_DateIssueSubType_Verify_Escalation_Dismantled() throws Throwable{
	
		try{	
			fnApps_Report_Logs("=========================================================================================================================================");
			fnApps_Report_Logs("################### Test Case ::::::10 Escalation_FBY_Edit_05NOV_DateIssueSubType_Verify_Escalation_Dismantled.");
		...
		//	IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
			...
			fnDD_value_Select("ViewIssueSummaryDetails_IssueSubType_dd_click", "ViewIssueSummaryDetails_IssueSubType_dd_value", "li", IssueMgt_Suitexls.getCellData("Escalation_EightIssues_FBY", 2, 18));
	...
	@Test(dependsOnMethods={"Escalation_FBY_Edit_05NOV_DateIssueSubType_Verify_Escalation_Dismantled"}, priority = 11, description="  [Edit Issue8 SubType back to original and Verify new Escalation is generated with new escalation Id and all 8 issues exists int Escalation.]")
	public void Escalation_FBY_Edit_05NOV_DateIssueSubType_BackToOriginal_and_Verify_NEW_Escalation_ID_Generated() throws Throwable{
	
		try{		
			fnApps_Report_Logs("=========================================================================================================================================");
			fnApps_Report_Logs("################### Test Case ::::::11 Escalation_FBY_Edit_05NOV_DateIssueSubType_BackToOriginal_and_Verify_NEW_Escalation_ID_Generated ");
	//		IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
			...
			//Select IssueSubType From Drop Down
			fnDD_value_Select_By_UpKey("ViewIssueSummaryDetails_IssueSubType_dd_click", "ViewIssueSummaryDetails_IssueSubType_dd_value", "li",  IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 8));
	...
	@Test(dependsOnMethods={"Escalation_FBY_Edit_05NOV_DateIssueSubType_BackToOriginal_and_Verify_NEW_Escalation_ID_Generated"}, priority = 12, description="  [Change the status from >Initial Record >SATISFACTORY CLOSURE. Mention new status response>Click save. Check -Click on Assign to me Button.]")
	...
	public void Escalation_Verify_AllIssuesClosed_As_EscalationClosed() throws Throwable{
		...
		fnApps_Report_Logs("#################################### [BS - 12]  CreateEscalation_FBY_8Issues_Scenario1 Script END ##################################### ");
		fnApps_Report_Logs("=========================================================================================================================================");

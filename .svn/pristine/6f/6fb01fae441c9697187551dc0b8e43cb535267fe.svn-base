...
public class CreateEscalation_PRQ extends TestSuiteBase_IM{
	...
	public static String TitleShortDescriptionText="CreateEsc_PRQ[BS-02], D/T=";	
...
public void Launch_Browser_and_Successfully_Login_into_the_Application() throws Throwable{
	fnApps_Report_Logs("################################## [BS-02]  Create Escalation PRQ");
	...
	@Test(dependsOnMethods={"Escalation_PRQ_SecondIssue_Amber"}, priority = 3, description="  [Create Issue ID with RED color]")
	...
	@Test(dependsOnMethods={"Escalation_PRQ_ThirdIssue_Red"}, priority = 4, description="  [Verify Escalations ID Generated with three issues.]")
	...
	@Test(dependsOnMethods={"Escalation_PRQ_Generated_With_3_Issues"}, priority = 5, description="  [Go to Summary tab > Click 'Assign to me'. Click Save.]")
	...
	public void Escalation_FirstIssue_Change_status_AdditionalInfoRequired_to_InitialRecord_andThen_Alerts_Verify() throws Throwable{
		...
		fnIssue_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_PRQ", 2, 14), issue_id_green);
...
//		IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
	...
	public void Escalation_FirstIssue_Change_status_DetailsSentToSupplier_to_IssueResponse_andThen_Alerts_Verify() throws Throwable{
		...
		fnIssue_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_PRQ", 2, 17), issue_id_green);
	...
	public void Escalation_FirstIssue_Change_status_IssueResponse_to_TechnologistApprovedToClose_andThen_Alerts_Verify() throws Throwable{
		...
		fnIssue_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_PRQ", 2, 18), issue_id_green);
	...
	public void Escalation_FirstIssue_Change_status_TechnologistApprovedToClose_to_SatisfactoryClosure_andThen_Alerts_Verify() throws Throwable{
		...
		fnIssue_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_PRQ", 2, 19), issue_id_green);
	...
	public void Escalation_EditEscalation_AssignToMeButtonClick_and_ALERTs_VERIFY() throws Throwable{
		fnApps_Report_Logs("=========================================================================================================================================");
		fnApps_Report_Logs("################### Test Case ::::::14 Escalation_EditEscalation_AssignToMeButtonClick_and_ALERTs_VERIFY ");
	...
	@Test(dependsOnMethods={"Escalation_EditEscalation_AssignToMeButtonClick_and_ALERTs_VERIFY"}, priority = 15, description="  [Link the technologist name .select radio button as NSF  and mention the Technologist name. Click save.]")
	public void Escalation_EditEscalation_SelectRadioButtonAsNSF_MentionTechnologistName_andThen_Alerts_Verify() throws Throwable{
		...
		fnApps_Report_Logs("=========================================================================================================================================");	
		fnApps_Report_Logs("################### Test Case ::::::15 Escalation_EditEscalation_SelectRadioButtonAsNSF_MentionTechnologistName_andThen_Alerts_Verify ");
	...
	@Test(dependsOnMethods={"Escalation_EditEscalation_SelectRadioButtonAsNSF_MentionTechnologistName_andThen_Alerts_Verify"}, priority = 16, description="  [Change the status from INITIAL RECORD > DETAILS SENT TO SUPPLIER .mention new status response>Click save.]")
	...
	public void Escalation_Verify_AllIssuesClosed_As_EscalationClosed() throws Throwable{
		...
		fnApps_Report_Logs("######################################### [BS - 02]  CreateEscalation_PRQ Script END ################################################## ");
		fnApps_Report_Logs("=========================================================================================================================================");

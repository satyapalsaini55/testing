...
_Log("")
_Log("")
_Log("************* Nsf-Online Bs06 Case3 script start")
WinWait("Microsoft Excel","",10)
If Not WinExists("Microsoft Excel","")Then
MsgBox(16, 'Case 3 -- AutoIt Scripts FAIL, Getting error: - ', '   Excel Yes button dialog box is not getting open after 15 Sec wait.', 20)
...
MsgBox(0, 'Case 3 -- AutoIt Scripts FAIL, Getting error: - ', '   Excel is not getting open after 15 Sec wait.', 20)
...
MsgBox(0, 'Case 3 -- AutoIt Scripts FAIL, Getting error: - ', $sFilePath & '   Excel Does NOT exists', 15)
...
If Not WinExists("Microsoft Excel","")Then
MsgBox(0, 'Case 3 -- AutoIt Scripts FAIL, Getting error: - ', '  Temp Excel Yes/No button dialog box is not getting open after 15 Sec wait.', 10)
...
_Log("************* Successfully Run Script Nsf-Online Bs06 Case3.")

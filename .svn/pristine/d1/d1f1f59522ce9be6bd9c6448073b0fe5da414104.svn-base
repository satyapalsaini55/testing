...
public class CreateIssue_NC extends TestSuiteBase_IM{
	
	public static String issue_id=""; 
	public static String validation_error_msg_text;
	public static String TitleShortDescriptionText="CreateIssue_NC[BS-07], D/T=";
...
public void Launch_Browser_and_Successfully_Login_into_the_Application() throws Throwable{
	fnApps_Report_Logs("################################## [BS-07]  Create Issue NC");
	...
	public void NC_CreateIssue() throws Exception{
		fnApps_Report_Logs("=========================================================================================================================================");
		fnApps_Report_Logs("################### Test Case ::::::1 NC_CreateIssue ");
	...
	//	IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
		...
		fnVerify_SiteDetailsPage_Data_Entered_and_NavigateTo_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("CreateIssue_NC", 2, 2), IssueMgt_Suitexls.getCellData("CreateIssue_NC", 2, 3));
	
		//Summary Details page data entered and clicking on next button
		fnVerify_SummaryDetailsPage_Data_Entered_and_NavigateTo_CustomerDetailsPage(IssueMgt_Suitexls.getCellData("CreateIssue_NC", 2, 8), IssueMgt_Suitexls.getCellData("CreateIssue_NC", 2, 9), IssueMgt_Suitexls.getCellData("CreateIssue_NC", 2, 10), fnGet_2Days_Past_date(), TitleShortDescriptionText);
		...
		fnVerify_ProductDetailsPage_Data_Entered_and_NavigateTo_DocumentsDetailsPage(IssueMgt_Suitexls.getCellData("CreateIssue_NC", 2, 12));
	...
	@Test(dependsOnMethods={"NC_CreateIssue"}, priority = 2, description="Verify Alert --- Food Issues Unassigned.")
	...
	public void Summary_Details_Updated() throws Throwable{
		...
		/fnDD_value_Select("ViewIssueSummaryDetails_technologist_name_dd_click", "ViewIssueSummaryDetails_technologist_name_dd_value", "li", IssueMgt_Suitexls.getCellData("CreateIssue_NC", 2, 15));
		*/
	...
	public void Change_status_InitialRecord_to_AdditionalInfoRequired() throws Throwable{
		...
		fnIssue_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("CreateIssue_NC", 2, 16), issue_id);
}
	...
	public void Change_Status_AdditionalInfoRequired_TO_InitialRecord() throws Throwable{
		...
		fnIssue_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("CreateIssue_NC", 2, 18), issue_id);
}
	...
	public void Change_status_InitialRecord_to_DetailsSentToSupplier() throws Throwable{
		...
		fnIssue_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("CreateIssue_NC", 2, 19), issue_id);
}
	...
	public void Change_status_DetailsSentToSupplier_to_IssueResponse() throws Throwable{
		...
		fnIssue_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("CreateIssue_NC", 2, 20), issue_id);
}
	...
	public void Change_status_IssueResponse_to_TechnologistApprovedToClose() throws Throwable{
		...
		fnIssue_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("CreateIssue_NC", 2, 21), issue_id);
	...
	public void Change_status_TechnologistApprovedToClose_to_SatisfactoryClosure() throws Throwable{
		...
		fnIssue_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("CreateIssue_NC", 2, 22), issue_id);	
}
	...
	public void SatisfactoryClosure_Check_IssueID_Not_Present_In_Alerts_After_Issue_Closed() throws Throwable{
		...
		fnApps_Report_Logs("######################################### [BS - 07]  CreateIssue_NC Script END ####################################################### ");
		fnApps_Report_Logs("=========================================================================================================================================");

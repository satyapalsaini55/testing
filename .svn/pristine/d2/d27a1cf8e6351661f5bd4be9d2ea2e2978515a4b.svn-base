...
_Log("************* Nsf-Online Bs06 Case7 i-Pulse script start")
WinWait("[CLASS:XLMAIN]","",15)
If Not WinExists("[CLASS:XLMAIN]","")Then
MsgBox(0, 'Case 7 -- AutoIt Scripts FAIL, Getting error: - ', '   Excel is not getting open after 15 Sec wait.', 10)
...
If Not WinExists("[CLASS:XLMAIN]","")Then
MsgBox(0, 'Case 7 -- AutoIt Scripts FAIL, Getting error: - ', '   stdSearch Excel is not exists Toclose.', 10)
...
_Log("************* Successfully Run Script Nsf-Online Bs06 Case7 i-Pulse. ")

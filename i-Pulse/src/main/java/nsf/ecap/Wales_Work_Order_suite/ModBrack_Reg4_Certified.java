...
public class ModBrack_Reg4_Certified extends TestSuiteBase_Wales_Work_Order_suite{
	...
	//@Test(priority = 1)
	@Test(priority = 1,dataProviderClass = TestDataProvider.class,dataProvider = "ModBrack_Reg4_Certified")

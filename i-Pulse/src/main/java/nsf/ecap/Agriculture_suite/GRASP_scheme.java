...
//BS-04
public class GRASP_scheme extends TestSuiteBase_Agriculture_suite {
...
/*				
			    String grasp_scheme_wo_link_xpath=OR.getProperty("WoLinkAtImportResultsScreen_part1")+IPULSE_CONSTANTS.GRASP_scheme_name+OR.getProperty("WoLinkAtImportResultsScreen_part2");
			    
				//String woNo = fnpGetText_OR("WoLinkAtImportResultsScreen");
				String woNo = fnpGetText_NOR(grasp_scheme_wo_link_xpath);
				fnpMymsg("Wo no. is ---"+woNo);
				//fnpClick_OR("WoLinkAtImportResultsScreen");
				fnpClick_NOR(grasp_scheme_wo_link_xpath);
				...
				*/
				...
				fnpMatchScheme(IPULSE_CONSTANTS.GRASP_scheme_name);

...
//BS-08
public class NN_Upto_Lit_PEval_Ready_No_Fac extends TestSuiteBase {
	...
	@Test(priority = 16, dependsOnMethods = { "Supplier_Forms_task" })
	...
	@Test(priority = 18, dependsOnMethods = { "Sample_Selection_Process_N_CheckAlerts" })
	...
	public void Literature_Eval_Till_Submit_Literature_Request_Pending_Action_Item() throws Throwable {

		fnpMymsg(" **************************************************************");
		fnpMymsg(" Executing Literature_Eval_Till_Submit_Literature_Request_Pending_Action_Item");
		try {
...
/*			
			fail = true;
			isTestPass = false;
			fnpMymsg("  Literature_Eval_Till_Submit_Literature_Request_Pending_Action_Item  method is failed . " + " . Error is ---" + t.getMessage());

			fnpDesireScreenshot("Literature_Eval_Till_Submit_Literature_Request_Pending_Action_Item");

			String stackTrace = Throwables.getStackTraceAsString(t);
			String errorMsg = t.getMessage();
			errorMsg = errorMsg
					+ "\n\n\n\n Literature_Eval_Till_Submit_Literature_Request_Pending_Action_Item  method is failed   .See screenshot 'Literature_Eval_Till_Submit_Literature_Request_Pending_Action_Item'\n\n"
					+ stackTrace;
			Exception c = new Exception(errorMsg);
			ErrorUtil.addVerificationFailure(c);
			*/
			
			fnpCommonFinalCatchBlock(t, " Literature_Eval_Till_Submit_Literature_Request_Pending_Action_Item  method is failed  . ", "Literature_Eval_Till_Submit_Literature_Request_Pending_Action_Item");

		}
	}

	
	@Test(priority = 20, dependsOnMethods = { "Literature_Eval_Till_Submit_Literature_Request_Pending_Action_Item" })

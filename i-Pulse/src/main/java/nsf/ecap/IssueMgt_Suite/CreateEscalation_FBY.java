...
public class CreateEscalation_FBY extends TestSuiteBase_IM{
	
	public static String issue_id_green="I0060274";
	public static String issue_id_amber="I0060275";
	public static String issue_id_red="I0060276";
	public static String Escalation_Id="E0005729";
	public static String validation_error_msg_text;
	public static String TitleShortDescriptionText="CreateEsc_FBY[BS-11], D/T=";	
...
public void Launch_Browser_and_Successfully_Login_into_the_Application() throws Throwable{
	fnApps_Report_Logs("################################## [BS-11]  Create Escalation FBY");
	...
	//	IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
		...
		fnVerify_SiteDetailsPage_Data_Entered_and_NavigateTo_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 2), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 3));
	
		//Summary Details page data entered and clicking on next button
		fnVerify_SummaryDetailsPage_Data_Entered_and_NavigateTo_CustomerDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 6), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 7), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 8), fnGet_2Days_Past_date(), TitleShortDescriptionText);
	...
	//	IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
		...
		//Site Details page data entered and clicking on next button
		fnVerify_SiteDetailsPage_Data_Entered_and_NavigateTo_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 2), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 4));
	...
	@Test(dependsOnMethods={"Escalation_FBY_SecondIssue_Amber"}, priority = 3, description="  [Create Issue ID with RED color]")
	public void Escalation_FBY_ThirdIssue_Red() throws Throwable{
		
		fnApps_Report_Logs("=========================================================================================================================================");
		fnApps_Report_Logs("################### Test Case ::::::3 Escalation_FBY_ThirdIssue_Red ");
	//	IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
		...
		//Site Details page data entered and clicking on next button
		fnVerify_SiteDetailsPage_Data_Entered_and_NavigateTo_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 2), IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 5));
	...
	@Test(dependsOnMethods={"Escalation_FBY_ThirdIssue_Red"}, priority = 4, description="  [Verify Escalations ID Generated with three issues.]")
	public void Escalation_FBY_Generated_With_3_Issues() throws Throwable{
		fnApps_Report_Logs("=========================================================================================================================================");
		fnApps_Report_Logs("################### Test Case ::::::4 Escalation_FBY_Generated_With_3_Issues ");
...
//		IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
	...
	@Test(dependsOnMethods={"Escalation_FBY_Generated_With_3_Issues"}, priority = 5, description="  [Go to Summary tab > Click 'Assign to me'. Click Save.]")
	...
	public void Escalation_FirstIssue_Change_status_InitialRecord_to_AdditionalinfoRequired_andThen_Alerts_Verify() throws Throwable{
		...
		fnIssue_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 15), issue_id_green);
	...
	public void Escalation_FirstIssue_SelectRadioButtonAsNSF_MentionTechnologistName_andThen_Alerts_Verify() throws Throwable{
		...
		/fnDD_value_Select("ViewIssueSummaryDetails_technologist_name_dd_click", "ViewIssueSummaryDetails_technologist_name_dd_value", "li", IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 12));
		*/
	...
	@Test(dependsOnMethods={"Escalation_FirstIssue_SelectRadioButtonAsNSF_MentionTechnologistName_andThen_Alerts_Verify"}, priority= 8, description="  [Change the status from AdditionalinfoRequired  >  INITIAL RECORD . mention new status response>Click save.]")
	public void Escalation_FirstIssue_Change_status_AdditionalinfoRequired_to_InitialRecord_andThen_Alerts_Verify() throws Throwable{
		...
		fnIssue_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 14), issue_id_green);
	...
	//	IssueMgt_Suitexls = new Xls_Reader(System.getProperty("user.dir") + "//src//nsf//ecap//xls//IssueMgt_Suite.xlsx");
		...
		fnDD_value_Select("ViewIssueSummaryDetails_new_status_dd_click", "ViewIssueSummaryDetails_new_status_dd_value", "li", IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 16));
	...
	public void Escalation_FirstIssue_Change_status_DetailsSentToSupplier_to_IssueResponse_andThen_Alerts_Verify() throws Throwable{
		...
		fnApps_Report_Logs("################### Test Case ::::::10 Escalation_FirstIssue_Change_status_DetailsSentToSupplier_to_IssueResponse_andThen_Alerts_Verify ");
			...
			fnIssue_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 17), issue_id_green);
	...
	public void Escalation_FirstIssue_Change_status_IssueResponse_to_TechnologistApprovedToClose_andThen_Alerts_Verify() throws Throwable{
		...
		fnApps_Report_Logs("################### Test Case ::::::11 Escalation_FirstIssue_Change_status_IssueResponse_to_TechnologistApprovedToClose_andThen_Alerts_Verify ");
			...
			fnIssue_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 18), issue_id_green);
	...
	public void Escalation_FirstIssue_Change_status_TechnologistApprovedToClose_to_SatisfactoryClosure_andThen_Alerts_Verify() throws Throwable{
		...
		fnApps_Report_Logs("########### Test Case :::12 Escalation_FirstIssue_Change_status_TechnologistApprovedToClose_to_SatisfactoryClosure_andThen_Alerts_Verify ");
			...
			fnIssue_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 19), issue_id_green);
	...
	public void Escalation_EditEscalation_AssignToMeButtonClick_and_ALERTs_VERIFY() throws Throwable{
		...
		//Select value from Technologist Name drop down
		/fnDD_value_Select("Escalation_Summary_TechnologistName_DD_Click", "Escalation_Summary_TechnologistName_DD_Value", "li", IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 20));
		*/
	...
	public void Escalation_EditEscalation_Change_status_InitialRecord_to_DetailsSentToSupplier_andThen_Alerts_Verify() throws Throwable{
		...
		fncEscalation_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 23));
	...
	public void Escalation_EditEscalation_Change_status_DetailsSentToSupplier_EscalationResponse_andThen_Alerts_Verify() throws Throwable{
		...
		fncEscalation_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 24));
	...
	public void Escalation_EditEscalation_Change_status_EscalationResponse_TechnologistApprovedToClose_andThen_Alerts_Verify() throws Throwable{
		...
		//Waiting for NEWStatus DD Enabled
		fnGet_Element_Enabled("Escalation_Summary_NewStatus_DD_click");
		
		//Select Status From Drop Down
		fnDD_value_Select("Escalation_Summary_NewStatus_DD_click", "Escalation_Summary_NewStatus_DD_Value", "li", IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 25));
		...
		fnWait_and_Type("Escalation_Summary_New_Status_Response_TextBox", "Edit Escalation, Status Changing from (Escalation Response) to (Technologist Approved To Close).");
		...
		try{
			assert !(fnGet_OR_IM_ObjectX("Escalation_Summary_Assign_To_Technologist_CheckBox").isSelected()):"'Assign To Technologist' checkBox is displayed as CHECKED, please refer screen shot >> CheckBoxIsSelected";
			fnApps_Report_Logs("PASSED == 'Assign To Technologist' checkBox is displayed as UN-CHECKED.");		
		}catch(Throwable t){
			isTestCasePass = false;
			fnTake_Screen_Shot("CheckBoxIsSelected");
			fnApps_Report_Logs(Throwables.getStackTraceAsString(t));
	...
	public void Escalation_EditEscalation_Change_status_TechnologistApprovedToClose_to_SatisfactoryClosure_andThen_Alerts_Verify() throws Throwable{
		...
		fncEscalation_VerifyChange_Status_on_SummaryDetailsPage(IssueMgt_Suitexls.getCellData("Escalation_FBY", 2, 26));
	...
	public void Escalation_Verify_AllIssuesClosed_As_EscalationClosed() throws Throwable{
		...
		fnApps_Report_Logs("######################################### [BS - 11]  CreateEscalation_FBY Script END ################################################## ");
		fnApps_Report_Logs("=========================================================================================================================================");
